...
run_coding_agent() {
...

  {
    ...
    echo "   - .claude/skills/thermo-nuclear-code-quality/SKILL.md — structural quality bar (the review agent enforces this)"
...
"
    ...
    echo ""
    echo "1. .claude/skills/thermo-nuclear-code-quality-review/SKILL.md — structural quality, code-judo, spaghetti detection"
    echo ""
    ...
    echo "3. Conventions: Does it follow the project conventions (see AGENTS.md)?"
